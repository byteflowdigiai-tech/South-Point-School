      ...
      <section id="mission" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-bold text-[#0d1b3e] mb-4">Vision, Mission & Values</h2>
      ...
      <section id="principal" className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-[#0d1b3e]">Principal's Message</h2>
            <div className="section-divider w-24 mx-auto mt-4" />
          </div>
          <div className="bg-[#f0f4ff] rounded-3xl p-10 border border-blue-100 relative">
      ...
      <section id="faculty" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-[#0d1b3e] mb-4">Distinguished Faculty</h2>
            <div className="section-divider w-24 mx-auto" />
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {faculty.map((f, i) => (
              ...
              >
                ...
                <div>
                  <div className="font-bold text-[#0d1b3e]">{f.name}</div>
                  <div className="text-[#1a3a80] text-sm font-medium">{f.role}</div>
