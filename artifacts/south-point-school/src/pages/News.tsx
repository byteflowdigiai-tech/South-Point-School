      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          {featured && filter === "All" && (
            ...
            >
              <div className="bg-[#0f1e3d] p-10 flex flex-col justify-center">
                <span className="inline-block bg-gold text-[#0f1e3d] text-xs font-bold px-3 py-1 rounded-full mb-4">Featured</span>
              ...
              <div className="bg-gradient-to-br from-amber-400/20 to-gold/10 flex items-center justify-center min-h-48 md:min-h-auto">
                <div className="text-center p-8">
                  ...
                  <div className="text-[#0f1e3d] font-bold text-lg">Outstanding Achievement</div>
            ...
            {categories.map(cat => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-semibold transition-all ${
                  filter === cat ? "bg-[#0f1e3d] text-gold" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
                }`}
              >
                {cat}
              </button>
            ...
            {rest.map((item, i) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <h3 className="font-bold text-[#0f1e3d] mb-2 leading-tight">{item.title}</h3>
                  <p className="text-gray-500 text-sm leading-relaxed">{item.excerpt}</p>
                  <button className="mt-4 text-[#7d2a1e] text-sm font-semibold flex items-center gap-1 hover:gap-2 transition-all">
