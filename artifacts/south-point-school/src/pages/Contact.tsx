      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-12">
            {/* Contact Info */}
            <div>
              <div className="text-xs font-bold tracking-widest uppercase text-[#7d2a1e] mb-3">Contact Details</div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={item.title} className="flex gap-4">
                    <div className="w-10 h-10 rounded-lg bg-[#0f1e3d] flex items-center justify-center shrink-0">
                      {item.icon}
                    </div>
                    <div>
                      <div className="font-semibold text-[#0f1e3d] text-sm mb-1">{item.title}</div>
              ...
              {/* Departments */}
              <div className="mt-10">
                <div className="font-semibold text-[#0f1e3d] mb-4">Quick Contacts</div>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={d.dept} className="p-3 rounded-lg bg-gray-50 border border-gray-100">
                      <div className="text-xs font-bold text-[#7d2a1e] uppercase tracking-wider">{d.dept}</div>
            ...
            <div className="lg:col-span-2">
              <div className="text-xs font-bold tracking-widest uppercase text-[#7d2a1e] mb-3">Write to Us</div>
              <h2 className="text-3xl font-bold text-[#0f1e3d] mb-8">Send a Message</h2>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <h3 className="text-[#0f1e3d] text-2xl font-bold mb-2">Message Sent!</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button type="submit"
                    className="w-full py-3.5 rounded-lg font-bold bg-[#0f1e3d] text-gold hover:bg-[#1a3060] transition flex items-center justify-center gap-2">
              ...
              <div className="mt-8 rounded-2xl overflow-hidden bg-gray-100 border border-gray-200 h-64 flex items-center justify-center">
                <div className="text-center text-gray-400">
                  ...
                  <a
                    ...
                    className="mt-3 inline-block text-sm font-semibold text-[#0f1e3d] hover:text-gold transition"
                  >
                    View on Google Maps →
                  </a>
                </div>
