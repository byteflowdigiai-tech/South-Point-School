...
const heroSlides = [
  {
    ...
    bg: "linear-gradient(135deg, #0a1428 0%, #1a2f5a 50%, #0d1f40 100%)",
    accent: "#c9a227",
  },
  {
    ...
    bg: "linear-gradient(135deg, #3d0a0a 0%, #5a1a1a 50%, #3d0d0d 100%)",
    accent: "#f0d060",
  },
  {
    ...
    bg: "linear-gradient(135deg, #0a1e2d 0%, #1a3a50 50%, #0d1e2e 100%)",
    accent: "#c9a227",
  },
];
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/admissions"
                  className="flex items-center gap-2 px-7 py-3.5 rounded font-semibold text-[#0f1e3d] gold-gradient hover:opacity-90 transition shadow-lg shadow-gold/20"
                >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-block text-xs font-bold tracking-widest uppercase text-[#7d2a1e] mb-3">
                About Our School
              </div>
              <h2 className="text-4xl font-bold text-[#0f1e3d] mb-6 leading-tight">
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                {[
                  ...
                  { icon: <BookOpen className="text-[#7d2a1e]" size={22} />, label: "NAAC Accredited" },
                  { icon: <Users className="text-[#1a3a6b]" size={22} />, label: "ISO Certified" },
                ].map((item) => (
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 px-6 py-3 rounded bg-[#0f1e3d] text-white font-semibold hover:bg-[#1a3060] transition"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { bg: "bg-[#0f1e3d]", text: "text-gold", title: "Vision", desc: "To be the leading institution developing globally competent, ethically grounded citizens." },
                { bg: "bg-[#7d2a1e]", text: "text-yellow-300", title: "Mission", desc: "Providing quality education that fosters intellectual curiosity and moral integrity." },
                { bg: "bg-amber-500", text: "text-[#0f1e3d]", title: "Values", desc: "Integrity, Excellence, Empathy, Innovation — the pillars of our school culture." },
                { bg: "bg-[#1a3a6b]", text: "text-gold-light", title: "Excellence", desc: "Consistently delivering outstanding academic and extracurricular achievements." },
              ].map((card) => (
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-14">
            <div className="text-xs font-bold tracking-widest uppercase text-[#7d2a1e] mb-3">Programmes Offered</div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {programs.map((prog, i) => (
              ...
              >
                ...
                <div className="text-[#0f1e3d] font-bold text-xl mb-1">{prog.title}</div>
                <div className="text-[#7d2a1e] text-sm font-semibold mb-3">{prog.grades}</div>
                <p className="text-gray-600 text-sm leading-relaxed">{prog.desc}</p>
                <Link href="/academics" className="inline-flex items-center gap-1 mt-4 text-xs font-semibold text-[#0f1e3d] hover:text-[#7d2a1e] transition">
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center justify-between mb-8">
                <div>
                  <div className="text-xs font-bold tracking-widest uppercase text-[#7d2a1e] mb-1">Stay Informed</div>
                  <h2 className="text-3xl font-bold text-[#0f1e3d]">Latest News</h2>
                </div>
                <Link href="/news" className="text-sm font-semibold text-[#0f1e3d] hover:text-gold flex items-center gap-1 transition">
              ...
              <div className="space-y-5">
                {newsItems.map((item, i) => (
                  ...
                  >
                    <div className="shrink-0 w-16 h-16 rounded-xl bg-[#0f1e3d] flex flex-col items-center justify-center text-gold">
                    ...
                    <div>
                      ...
                      <h3 className="font-semibold text-[#0f1e3d] group-hover:text-[#7d2a1e] transition mt-0.5">{item.title}</h3>
            ...
            <div>
              <div className="mb-8">
                <div className="text-xs font-bold tracking-widest uppercase text-[#7d2a1e] mb-1">Schedule</div>
                <h2 className="text-3xl font-bold text-[#0f1e3d]">Upcoming Events</h2>
              </div>
              <div className="space-y-4">
                {events.map((event, i) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: i * 0.1 }}
                    className="flex gap-4 items-start p-4 rounded-xl bg-gray-50 hover:bg-[#0f1e3d] transition group cursor-pointer border border-gray-100"
                  >
                    ...
                    <div>
                      <div className="font-semibold text-[#0f1e3d] group-hover:text-white text-sm leading-snug">{event.title}</div>
              ...
              <div className="mt-6 rounded-xl navy-gradient p-6 text-center">
                ...
                <Link
                  href="/admissions"
                  className="block px-5 py-2.5 rounded font-semibold gold-gradient text-[#0f1e3d] text-sm hover:opacity-90 transition"
                >
                  Apply Now →
                </Link>
              </div>
      ...
      <section className="py-20 bg-amber-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <div className="text-xs font-bold tracking-widest uppercase text-[#7d2a1e] mb-3">Voices</div>
            <h2 className="text-4xl font-bold text-[#0f1e3d] mb-4">What Our Community Says</h2>
            <div className="section-divider w-24 mx-auto" />
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-[#0f1e3d] flex items-center justify-center text-gold font-bold">
                    {t.initial}
                  </div>
                  <div>
                    <div className="font-semibold text-[#0f1e3d] text-sm">{t.name}</div>
      ...
      {/* CTA Banner */}
      <section className="py-16 bg-[#7d2a1e]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/admissions" className="px-8 py-3.5 rounded font-bold gold-gradient text-[#0f1e3d] hover:opacity-90 transition shadow-lg">
              Apply for Admission
            </Link>
